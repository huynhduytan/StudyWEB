...
if(isset($_POST['btnDangKy']))
{
    ...
    try {
        ...
        //Recipients
        $mail->setFrom('huynhduytan0501@gmail.com', 'Test Mail');
        ...
        <table>
            ...
            <tr>
                <td>
                    ...
                    <a href="$siteUrl/StudyWEB/backend/pages/kichhoattaikhoan.php?kh_tendangnhap=$kh_tendangnhap&kh_makichhoat=$kh_makichhoat">Kích hoạt tài khoản</a>
                </td>
            </tr>
            <tr>
                <td>
